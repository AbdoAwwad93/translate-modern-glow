            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="px-4 py-3 pr-12 rounded-xl border-2 border-border bg-background text-foreground focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all"
                />
